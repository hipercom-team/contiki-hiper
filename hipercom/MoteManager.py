...
class MoteManager:
    ...
    def getMoteTable(self):
        ...
        for line in moteStr.split("\n"):
            ...
            result.append((moteName,ttyName))
        return dict(result)

    def getMoteIdTable(self):
        return dict(( (MoteDatabase[moteName], ttyName)
                    for moteName,ttyName in self.getMoteTable().iteritems() ))

    def getMoteById(self, moteId):
        return self.getMoteByTty(self.getMoteIdTable()[moteId], moteId)

    def getMoteByTty(self, ttyName, moteId = None):
        return Mote(ttyName, moteId, self)

    def resetMoteByTty(self, ttyName):
    ...
    def getBslCommand(self):
        return self.contikiDir+"/tools/z1/z1-bsl-nopic --z1"

#..................................................

class Mote:
    def __init__(self, ttyName, moteId = None, manager = None):
    ...
    def reset(self):
        self.ensureNoPort()
        self.manager.resetMoteByTty(self.ttyName)
    ...
    def flashFirmware(self, z1Firmware):
        ...
        moteBsl = self.manager.getBslCommand()
...
def getMoteFromArg(argList, option):
    ...
    if option.moteId != None:
        ...
        if option.exitIfNoMote and (moteId not in moteTable):
            ...
            ttyName = moteTable[moteId]
            mote = Mote(ttyName, moteId, manager)
    else: mote = Mote(option.ttyName)
    return mote
